  ...
  return (
    <section className="hero" aria-label="Introduction">
      <div className="container"><div className="hero-grid"><div>
        ...
        <div className="hero-ctas"><Link to="/contact" className="btn btn-primary">Get in Touch →</Link><a href={siteConfig.resume} className="btn btn-secondary" download="Hussain-Hakimi-Resume.pdf">Download Resume</a></div>
      ...
      </div><div className="hero-image-wrapper"><div><div className="hero-image-ring"><img className="hero-image" src="/images/Hussain%20Hakimi%20profle%20picture.JPG" alt="Hussain Hakimi" width="640" height="640" fetchPriority="high" /></div><div className="hero-social-links"><a href={siteConfig.github} className="social-pill" target="_blank" rel="noopener noreferrer" aria-label="GitHub profile"><span aria-hidden="true">⚡</span> GitHub</a><a href={siteConfig.linkedin} className="social-pill" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn profile"><span aria-hidden="true">💼</span> LinkedIn</a></div></div></div></div></div>
    </section>
  );
}
