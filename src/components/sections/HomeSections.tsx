    ...
    <div className="modal-overlay" onClick={onClose} role="dialog" aria-modal="true" aria-label={project.title}>
      <div className="modal" ref={modalRef} onClick={e => e.stopPropagation()}>
        ...
        <div className="modal-body">
          <div className="modal-image" aria-hidden="true">{project.emoji}</div>
...
export function HeroSection() {
  ...
  return (
    <section className="hero" aria-label="Introduction">
      ...
      </div><div className="hero-image-wrapper"><div><div className="hero-image-ring"><div className="hero-image" aria-label="Profile photo of Hussain Hakimi">👨‍💻</div></div><div className="hero-social-links"><a href={siteConfig.github} className="social-pill" target="_blank" rel="noopener noreferrer" aria-label="GitHub profile"><span aria-hidden="true">⚡</span> GitHub</a><a href={siteConfig.linkedin} className="social-pill" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn profile"><span aria-hidden="true">💼</span> LinkedIn</a></div></div></div></div></div>
    </section>
  );
}
