    ...
    <div className="modal-overlay" onClick={onClose} role="dialog" aria-modal="true" aria-label={project.title}>
      <div className="modal" ref={modalRef} onClick={e => e.stopPropagation()}>
        <div className="modal-header">
          ...
          <button className="modal-close" onClick={onClose} ref={closeRef} aria-label="Close modal">
            ✕
          </button>
        </div>
        <div className="modal-body">
          ...
          <div className="modal-links">
            ...
            <a href={project.repoUrl} className="btn btn-secondary btn-sm" target="_blank" rel="noopener noreferrer">
              View Repo
            </a>
          </div>
        </div>
        ...
        <div className="hero-grid">
          <div>
            ...
            <h1 className="hero-title">
              {displayed}
              <span className="typewriter-cursor" style={{ opacity: done ? 1 : 1 }} aria-hidden="true"></span>
            </h1>
            
            <p className="hero-subtitle">
              Software Engineering student at UET Lahore, passionate about frontend development, 
              database design, and data analytics. I build beautiful, performant web experiences.
            </p>
            ...
            <div className="hero-ctas">
              ...
              <a href={siteConfig.resume} className="btn btn-secondary" download>
                Download Resume
              </a>
            </div>
          ...
          <div className="hero-image-wrapper">
            <div>
              <div className="hero-image-ring">
                <div className="hero-image" aria-label="Profile photo of Hussain Hakimi">
                  👨‍💻
                </div>
              </div>
              <div className="hero-social-links">
                <a href={siteConfig.github} className="social-pill" target="_blank" rel="noopener noreferrer" aria-label="GitHub profile">
                  <span aria-hidden="true">⚡</span> GitHub
                </a>
                <a href={siteConfig.linkedin} className="social-pill" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn profile">
    ...
    <section className="section section-alt" aria-labelledby="about-heading">
      <div className="container">
        <AnimatedSection>
          ...
          <h2 id="about-heading" className="section-title">From Business to Building Software</h2>
        </AnimatedSection>
        ...
        <div className="about-grid" style={{ marginTop: '40px' }}>
          <AnimatedSection>
            <div className="about-text">
              <p>
                I'm Hussain Hakimi, a Software Engineering student at UET Lahore with a unique background. 
                I started my academic journey in Business Administration, but a chance encounter with web 
                development changed my trajectory forever.
              </p>
              <p>
                What began as curiosity quickly became passion. I spent countless nights building projects, 
                learning new technologies, and immersing myself in the developer community. The ability to 
                create something from nothing — just logic and creativity — captivated me.
              </p>
              <p>
                Today, I focus on frontend development, database design, and data analytics. I believe in 
                building software that is not just functional, but beautiful and accessible to everyone.
              </p>
            </div>
          </AnimatedSection>
          ...
          <AnimatedSection>
            <div className="about-card">
              ...
              <div className="about-card-item">
                ...
                <span className="about-card-value">UET Lahore</span>
              </div>
              <div className="about-card-item">
                <span className="about-card-label">Timeline</span>
...
// Projects Section
// ============================================
function ProjectsSection({ showAll = false }: { showAll?: boolean }) {
    ...
    <section className="section" aria-labelledby="projects-heading">
      <div className="container">
        <AnimatedSection>
          ...
          <p className="section-subtitle">A selection of projects that showcase my skills in frontend development and data analytics.</p>
        </AnimatedSection>
        
        <AnimatedSection>
          <div className="filter-buttons" style={{ marginTop: '32px' }} role="group" aria-label="Filter projects">
    ...
    <section className="section section-alt" aria-labelledby="experience-heading">
      <div className="container">
        <AnimatedSection>
          ...
          <h2 id="experience-heading" className="section-title">Where I've been</h2>
        </AnimatedSection>
    ...
    <section className="section" aria-labelledby="skills-heading">
      <div className="container">
        <AnimatedSection>
          ...
          <h2 id="skills-heading" className="section-title">Technologies I work with</h2>
      ...
      <div className="container">
        <AnimatedSection>
          <div className="contact-section">
            ...
            <h2 id="contact-heading" className="contact-title">Let's build something together</h2>
