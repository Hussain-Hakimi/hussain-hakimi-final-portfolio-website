...
export default function ProjectDetail() {
  ...
  return (
    <div className="project-detail">
      <Link to="/projects" className="blog-post-back">← Back to Projects</Link>
      
      <div className="project-detail-hero" aria-hidden="true">{project.emoji}</div>
      ...
      <div className="project-detail-content">
        ...
        <h2>Tech Stack</h2>
        <div className="modal-tags" style={{ marginBottom: '32px' }}>
